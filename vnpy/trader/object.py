...
class TickSubscribeRequest(BaseSubscribeRequest):
    """Request class for tick data subscription"""
    pass

@dataclass
class TradeSubscribeRequest(BaseSubscribeRequest):
    """Request class for trade data subscription"""
    pass

@dataclass
class KlineSubscribeRequest(BaseSubscribeRequest):
    """Request class for kline data subscription"""
    interval: Interval
