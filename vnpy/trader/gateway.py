...
from vnpy_evo.trader.object import BinanceTicker, BinanceTrade, BinanceAggregatedTrade, BinanceKlineData,BinanceDepthData
...
class BaseGateway(ABC):
    ...
    * on_contract
    ...
    def on_binance_tick(self, tick: BinanceTicker) -> None:
        """
        Tick event push.
        Tick event of a specific vt_symbol is also pushed.
        """
        print(tick)
        self.on_event(EVENT_TICK_BINANCE, tick)
    ...
    def on_binance_trade(self, trade: BinanceTrade) -> None:
        ...
        """
        print(trade)
        self.on_event(EVENT_TRADE_BINANCE, trade)

    def on_binance_aggtrade(self, trade: BinanceAggregatedTrade) -> None:
        """
        Trade event push.
        Trade event of a specific vt_symbol is also pushed.
        """
        print(trade)
        self.on_event(EVENT_AGGTRADE_BINANCE, trade)

    def on_1m_kline(self, bar: BinanceKlineData) -> None:
        """
        Bar event push.
        Bar event of a specific vt_symbol is also pushed.
        """
        print(bar)
        self.on_event(EVENT_BAR_BINANCE, bar)

    def on_binance_depth(self,depth: BinanceDepthData) -> None:
        """
        Trade event push.
        Trade event of a specific vt_symbol is also pushed.
        """
    ...
    @abstractmethod
    def subscribe(self, req: BaseSubscribeRequest) -> None:
        """
